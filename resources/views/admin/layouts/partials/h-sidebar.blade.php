    ...
    <div class="navbar-header d-xl-none d-block">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <h2 class="brand-text mb-0">MASSARK</h2>
                </a>
            </li>
    ...
    <div class="navbar-container main-menu-content" data-menu="menu-container">
        <ul class="nav navbar-nav" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="filled">
            ...
            <li class=" nav-item {{ request()->is('admin') ? 'active' : '' }}">
                <a class="dropdown-toggle nav-link" href="{{ url('admin') }}" data-toggle="">
            ...
            @canany(['users.index'])
                ...
                " data-menu="dropdown">
                    <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">
                        ...
                        <span data-i18n="Persons">{{ __('Persons') }}</span></a>
                    <ul class="dropdown-menu">
                        @can('users.index')
                            <li data-menu="">
                                <a class="dropdown-item align-items-center" href="{{ route('users.index') }}"
            ...
            @canany(['language.index', 'roles.index', 'country.index', 'city.index'])
                ...
                "
                    ...
                    <a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">
                        ...
                        <span data-i18n="Settings">{{ __('Settings') }}</span></a>
                    <ul class="dropdown-menu">

                        @can('language.index')
                            <li data-menu="">
                                <a class="dropdown-item align-items-center" href="{{ route('language.index') }}"
                                   data-toggle="dropdown">
                                    <i class="bx bx-right-arrow-alt"></i>
                                    <span data-i18n="Languages">{{ __('Languages') }}</span></a>
                            </li>
                        @endcan
                        ...
                        @can('city.index')
                            <li data-menu="">
                                <a class="dropdown-item align-items-center" href="{{ url('admin/city') }}"
                                   data-toggle="dropdown">
                                    <i class="bx bx-right-arrow-alt"></i>
                                    <span data-i18n="Countries">{{ __('Cities') }}</span></a>
                            </li>
                        @endcan

                        @can('lines.index')
                            <li data-menu="">
                                <a class="dropdown-item align-items-center" href="{{ url('admin/lines') }}"
                                   data-toggle="dropdown">
                                    <i class="bx bx-right-arrow-alt"></i>
                                    <span data-i18n="Countries">{{ __('Lines') }}</span></a>
                            </li>
                        @endcan
