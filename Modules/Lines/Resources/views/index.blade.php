        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="breadcrumbs-top">
                    <h5 class="content-header-title float-left pr-1 mb-0">{{ __('Lines Management') }}</h5>
                    <div class="float-right">
                        <a href="{{ route('lines.create') }}" class="btn  btn-primary"> <i
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Lines') }}</h4>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($result as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->id }}</td>
                                                    <td>{{ $item->name }}</td>
                                                    <td>{{ $item->startCity->city_name }}</td>
                                                    <td>{{ $item->endCity->city_name }}</td>
                                                    <td>@foreach($item->stoppoints as $point)
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <x-edit-component :href="route('lines.edit', [$item->id])" permission="line.edit" />
                                                                <x-delete-component :href="route('lines.destroy', [$item->id])" permission="line.destroy" :id="$item->id" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
