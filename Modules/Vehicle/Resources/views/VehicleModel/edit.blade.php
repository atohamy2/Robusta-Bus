            ...
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="breadcrumbs-top">
                    ...
                    <div class="float-right">
                        <a href="{{ route('vehiclemodel.index') }}" class="btn  btn-danger">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Edit Vehicle Model') }}</h4>
                                <x-lang-switcher-component :languages=" $languages "/>
                            </div>
                            <div class="card-body">
                                <form class="form" action="{{ route('vehiclemodel.update', $model->id) }}" method="POST">
                                    @method('PUT')
                                    @include('vehicle::VehicleModel.form')
                                </form>
                            </div>
                        </div>
                    </div>
