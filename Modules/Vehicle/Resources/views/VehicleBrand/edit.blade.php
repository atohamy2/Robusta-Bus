        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="breadcrumbs-top">
                    <h5 class="content-header-title float-left pr-1 mb-0">{{ __('Vehicle Brand Management') }}</h5>
                    <div class="float-right">
                        <a href="{{ route('vehiclebrand.index') }}" class="btn  btn-danger">
                    ...
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Edit Vehicle Brand') }}</h4>
                                <x-lang-switcher-component :languages=" $languages "/>
                            </div>
                            <div class="card-body">
                                <form class="form" action="{{ route('vehiclebrand.update', $model->id) }}" method="POST">
                                    @method('PUT')
                                    @include('vehicle::VehicleBrand.form')
                                </form>
                            </div>
                        </div>
                    </div>
