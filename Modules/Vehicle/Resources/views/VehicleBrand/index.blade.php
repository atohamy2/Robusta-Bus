        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="breadcrumbs-top">
                    <h5 class="content-header-title float-left pr-1 mb-0">{{ __('Vehicle Brands Management') }}</h5>
                    <div class="float-right">
                        <a href="{{ route('vehiclebrand.create') }}" class="btn  btn-primary"> <i
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Vehicle Brands') }}</h4>
                            </div>
                                        ...
                                        <tbody>
                                            @foreach ($result as $item)
                                                <tr>
                                                    ...
                                                    <td>{{ __($item->vehicle_brand_type) }}</td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <x-edit-component :href="route('vehiclebrand.edit', [$item->id])" permission="vehiclebrand.edit" />
                                                                <x-delete-component :href="route('vehiclebrand.destroy', [$item->id])" permission="vehiclebrand.destroy" :id="$item->id" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
